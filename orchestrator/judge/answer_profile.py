...
to a position, how much of the question it covers, and whether it contributes anything
the others do not. An author weighing a panel needs both — a claim backed by three
evasive answers that each addressed a third of the question is not the same finding as
one backed by three committed, complete ones, and the support numbers alone cannot
tell them apart.
"""
